...
Route::any('schedule-call/{id?}/{call_id?}', [HomeController::class, 'scheduleCall'])->name('schedule-call')->middleware('auth');
Route::post('token', [HomeController::class, 'token'])->name('token')->middleware('auth');
