                        ...
                        <div class="elementor-element elementor-element-6047abf elementor-widget elementor-widget-image"
                            ...
                            <div class="elementor-widget-container">
                                <img decoding="async" width="750" height="375"
                                    src="{{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }}"
                                    class="attachment-large size-large wp-image-6398" alt=""
                                    srcset="{{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }} 1024w, {{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }} 300w, {{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }} 768w, {{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }} 1536w, {{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }} 2048w, {{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }} 1568w, {{ asset('public/wp-content/uploads/2023/07') }}/{{ $related_post->image }} 1300w"
