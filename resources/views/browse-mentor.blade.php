    ...
    <head>
        <eta charset="UTF-8">
            ...
            <cript>
                ...
                <itle>Browse Mentor &#8211; wiseAdvizor<title>
                        ...
                        <ink rel="stylesheet"
                            ...
                            <link rel="stylesheet"
                                href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/css/bootstra-select.min.css">
                            ...
                            wndow._wpemojiSettings = {
                                ...
                                "svgExt": ".svg",
                                "source": {
                                    "concatemoji": "\http:\/\/localhost\/wiseAdvizor\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.22"
                                }
                            };
                            /! This file is auto-generated */! function(e, a, t) {
                                ...
                                function s(e, t) {
                                    ...
                                    e = i.toDataURL();
                                    return p.clearRect(0, 0, i.width, i.height), p.fillText(t, 0, 0), e === i
                                    .toDataURL()
                                }
                                ...
                                for (o = Array("flag", "emoji"), t.supports = {
                                        ...
                                        if (p && p.fillText) switch (p.textBaseline = "top", p.font = "600 32px Arial",
                                            e) {
                                            case "flag":
                            ...
                            :root .has-purple-crush-gradient-background {
                                background: linear-gradient(35deg, #34e2e4, #4721fb 50%, #ab1dfe)
                            }

                            :oot .has-hazy-dawn-gradient-background {
                            ...
                            hml :where([style*=bordr-left-color]) {
                            ...
                            hml :where([style*=order-right-width]) {
                                border-right-style: solid
                            }
                            ...
                            as="style"id="tpgb-fontawesome"media="all"onload="this.onload=null;this.rel='styleseet'"><noscript><link rel="stylesheet"id="tpgb-fontawesome-css"
                            href="{{ asset('public/wp-content/plugins/the-plus-addons-for-block-editor/assets/ss/extra/fontawesome.min.css?ver=6.2.2') }}"
                            ...
                            href="{{ asset('public/wp-content/uploads/theplus_gutenberg/plus-global.css?ver=1688368797') }}"media="all"><style id="global-styles-inline-css">bdy {
                                ...
                                --wp--preset--gradient--vivid-cyan-blue-to-vivid-purple: linear-gradient(135deg, rgba(6, 147, 227, 1) 0%, rgb(15, 81, 224) 100%);
                                ...
                                --wp--preset--gradient--blush-light-purple: linear-gradient(135deg, rgb(255, 206, 36) 0%, rgb(152, 150, 240) 100%);
                                --wp--preset--gradient--blush-bordeaux: linear-gradient(135deg, rgb(254, 205, 165) 0%, rgb(254, 45, 45) 50%, rgb(107, 0, 62) 100%);
                                --wp--preset--gradient--luminous-dusk: linear-gradient(135deg, rgb(255, 203, 112) 0%, rgb(199, 81, 192) 50%, rgb(65, 88, 208) 100%);
                                --wp--preset--gradient--pale-ocean: linear-gradient(135deg, rgb(255, 245, 203) 0%, rgb(182, 227, 212) 50%, rgb(51, 167, 181) 100%);
                                --wp--preset--gradient--electric-grass: linear-gradient(135deg, rgb(202, 248, 128) 0%, rgb(113, 206, 126) 100%);
                                --wp--preset--gradient--midnight: linear-gradient(135deg, rgb(2, 3, 129) 0%, rgb(40, 116, 252) 100%);
                                --wp--preset--gradient--vertical-secondary-to-tertiary: linear-gradient(to bottom, var(--wp--prset--color--secondary) 0%, var(--wp--preset--color--tertiary) 100%);
                                ...
                                --wp--preset--gradient--diagonal-primary-to-foreground: lnear-gradient(to bottom right, var(--wp--preset--color--primary) 0%, var(--wp--preset--color--foreground) 100%);
                                ...
                                --wp--preset--duotone--idnight: url('#wp-duotone-midnight');
                                --wp--preset--duotone--magenta-yellow: url('#wp-duotone-magenta-yellow');
                                --wp--preset--duotone--purple-green: url('#wp-duotone-purple-green');
                                --wp--prest--duotone--blue-orange: url('#wp-duotone-blue-orange');
                                ...
                                --wp--preset--duotone--oreground-and-tertiary: url('#wp-duotone-foreground-and-tertiary');
                            ...
                            <link rel="stylesheet" id="elementor-post-2772-css"
                                href="{{ asset('public/wp-content/uploads/elementor/css/post-2772.css?ver=1688723442') }}"
                                media="all">
                            <link rel="stylesheet" id="elementor-post-3007-css"
                                href="{{ asset('public/wp-content/uploads/elementor/css/post-3007.css?ver=1688644136') }}"
                                media="all">
                            ...
                            <link rel="stylesheet" id="theplus-front-css-css"
                                href="{{ asset('public/wp-content/uploads/theplus-addons/theplus.min.css?ver=1688723442') }}"
                                media="all">
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-c828001 elementor-widget elementor-widget-heading"
                                ...
                                <div class="elementor-widget-container">
                                    ...
                                    <h1 class="elementor-heading-title elementor-size-default">Browse mentor and
                                        schedule a
                                        call right away</h1>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2 col-6 mx-auto">
                                ...
                                <a href="{{ route('schedule-call', [$mentor->id]) }}" class="btn btn-primary mid-center"
                                    style="background-color:#001E64; align:center;">Schedule Call</a></br>
                                @else
                                <a href="{{ route('login', ['schedule-call', $mentor->id]) }}"
                                    class="btn btn-primary mid-center"
                                    style="background-color:#001E64; align:center;">Schedule Call</a></br>
                                @endif
                                <a href="{{ route('profile', [$mentor->id]) }}" class="card-link mid-center"
