            ...
            <div class="col-lg-8 d-flex align-items-center">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown pe-2 d-flex align-items-center">
                        <a href="javascript:;" class="nav-link text-body p-0" id="navbarDropdown"
                            data-bs-toggle="dropdown" aria-expanded="false">Resource
                            <!-- <a class="nav-link text-body p-0" href="javascript:;" id="navbarDropdown" role="button"
