            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Glossary</li>
                    </ol>
                    ...
                    <div class="card mt-4">
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                <div class="col-6 d-flex align-items-center">
                                    <h6 class="mb-0">Edit Term Content</h6>
                                </div>
                        ...
                        <div class="card-body px-0 pb-2">
                            <form method="POST" action="{{ route('admin.mentors.glossary.content.save') }}"
                                ...
                                <div>
                                    <label>Terms</label>
                                    <select class="select form-control terms" id="terms" name="terms" required>
