                ...
                <div class="row gx-4 mb-2">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ asset('public/assets/img/').'/' }}{{ $data->metaData ? $data->metaData->profile_pic : '' }}"
                    ...
                    <div class="col-auto my-auto">
                        <div class="h-100">
                            ...
                            <p class="mb-0 font-weight-normal text-sm">
                                {{ $data->metaData ? $data->metaData->designation : '' }}
                            </p>
                            <p class="mb-0 font-weight-normal text-sm">
                                {{ $data->metaData ? $data->metaData->company : '' }}
                            </p>
                        </div>
                    </div>
                      ...
                      <div class="form-check form-switch ps-0">
                        ...
                        <div class="col-12 col-xl-4">
                            <div class="card card-plain h-100">
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-end">
                                            <a href="{{ route('admin.users.add',[$data->id]) }}">
                                ...
                                <div class="card-body p-3">
                                    <p class="text-sm">
                                        {{ $data->metaData ? $data->metaData->about_me : ''}}
                                    </p>
                                    <hr class="horizontal gray-light my-4">
                                    <ul class="list-group">
                                        <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                                                class="text-dark">Full Name:</strong> &nbsp; {{ $data->name ?: '' }}
                                        </li>
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                                class="text-dark">Mobile:</strong> &nbsp;
                                            {{ $data->metaData ? $data->metaData->mobile : '' }}</li>
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                                class="text-dark">Email:</strong> &nbsp; {{ $data->email ?: '' }}</li>
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                                class="text-dark">Location:</strong> &nbsp;
                                            {{ $data->metaData ? $data->metaData->address : '' }}</li>
