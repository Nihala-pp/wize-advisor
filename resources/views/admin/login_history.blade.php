            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Login Histories</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Login Histories</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Login Histories</h6>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        @php
                                                        $profile = $activity->user->metaData ? $activity->user->metaData->profile_pic : '/';
                                                        @endphp
                                                        <img src="{{ asset('assets/img/').'/'.$profile }}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    ...
                                                    <p class="text-xs text-secondary mb-0">{{ $activity->user->name }}</p>
