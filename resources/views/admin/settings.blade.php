          ...
          <div class="card my-4">
            ...
            <form method="POST" action="{{ route('admin.settings.update') }}">
                ...
                <div class="input-group input-group-outline my-3">
                  <textarea class="form-control" name="about_us" rows="10" placeholder="About Us" spellcheck="true"></textarea>
                </div>
                <div class="input-group input-group-outline my-3">
                  <textarea class="form-control" name="contact_us" rows="10" placeholder="Contact Us" spellcheck="true"></textarea>
                </div>
                <div class="input-group input-group-outline my-3">
                  <textarea class="form-control" name="terms_conditions" rows="10" placeholder="Terms and Conditions" spellcheck="true"></textarea>
                </div>
                <div class="input-group input-group-outline my-3">
