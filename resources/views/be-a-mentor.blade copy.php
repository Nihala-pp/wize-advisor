                        ...
                        <div class="row" id="row">
                            <form method="POST" action="{{ route('addMentorRequest') }}">
                                ...
                                <div class="input-group input-group-static mb-4">
                                    <label for="exampleFormControlSelect1" class="ms-0">What is your professional status
                                        ?</label>
                                ...
                                <div>
                                    <label class="form-label">Have you any experience in working as a mentor/advisor to
                                        a start-up ?</label>
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="experience" id="customRadio1"
                                            value="yes">
                                        <label class="custom-control-label" for="customRadio1">Yes</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="experience" id="customRadio2"
                                            value="no">
                                ...
                                <div>
                                    <label for="exampleFormControlSelect1" class="ms-0">Are you looking to charge for
                                        your sessions ?</label>
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="is_charged" id="customRadio1"
                                            value="yes">
                                        <label class="custom-control-label" for="customRadio1">Yes</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_charged" id="customRadio2"
                                            value="no">
                                        <label class="custom-control-label" for="customRadio2">No</label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label class="form-label">What are your areas of expertise ? (Type and Press
                                        Enter)</label>
                                    <input name="expertise[]" class="form-control" id="expertise-tags" data-color="dark"
                                        type="text" required>
                                </div>
