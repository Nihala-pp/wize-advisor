...
">
    ...
    <meta property="og:url" content="https://wiseadvizor.com/glossary/{{ Str::slug($data->terms) }}">
    ...
    <meta name="twitter:url" content="https://wiseadvizor.com/glossary/{{ Str::slug($data->terms) }}">
    ...
    <link rel="canonical" href="https://wiseadvizor.com/glossary/{{ Str::slug($data->terms) }}">
                                        ...
                                        <div class="elementor-element elementor-element-4af5308 elementor-widget__width-initial elementor-widget elementor-widget-image"
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <img decoding="async" width="150" height="150"
                                                    src="{{ asset('wp-content/uploads/2024/06/Ankur.webp') }}"
                                                    class="attachment-thumbnail size-thumbnail wp-image-5883"
                                                    alt="startup success"
                                                    srcset="{{ asset('wp-content/uploads/2024/06/Ankur.webp') }} 150w, {{ asset('wp-content/uploads/2024/06/Ankur.webp') }} 700w, {{ asset('wp-content/uploads/2024/06/Ankur.webp') }} 650w, {{ asset('wp-content/uploads/2024/06/Ankur.webp') }} 1300w, {{ asset('wp-content/uploads/2024/06/Ankur.webp') }} 98w"
        ...
        <section
            ...
            <div class="elementor-container elementor-column-gap-no">
                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-c225fe8"
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <section
                            class="elementor-section elementor-inner-section elementor-element elementor-element-cde1c52 elementor-section-boxed elementor-section-height-default elementor-section-height-default wpr-particle-no wpr-jarallax-no wpr-parallax-no wpr-sticky-section-no"
                                ...
                                <div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-8589e92"
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        ...
                                        <div class="elementor-element elementor-element-9f5ff1a elementor-widget elementor-widget-text-editor"
                                            ...
                                            data-widget_type="text-editor.default">
                                            <div class="elementor-widget-container">
                                                <p>{{ Str::limit($related_mentor->metaData->bio_1, 103, (' ....')) }}
                                                </p>
                                            </div>
                                        </div>
