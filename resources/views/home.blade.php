    ...
    <head>
        <eta charset="UTF-8">
            ...
            <cript>
                ...
                vr theplus_nonce = "db17101d24"
                </script>
                <meta name="robots" content="max-image-preview:large">
                <itle>Home &#8211; wiseAdvizor</title>
                    ...
                    <ink rel="icon" type="image/png" href="{{ asset('public/assets/img/PNG-Blue.png') }}">
                        ...
                        wndow._wpemojiSettings = {
                            ...
                            "svgExt": ".svg",
                            "source": {
                                "concatemoji": "\http:\/\/localhost\/wiseAdvizor\/wp-includes\/js\/wp-emoji-release.mn.js?ver=6.2.2"
                            }
                        };
                            ...
                            t.supports.everythingExceptFlag = t.supports.everythingExceptFlag && !t.supports.flag, t
                                ...
                                .readyCallback = function() {
                                    t.DOMReady = !0
                                        ...
                                        })), (e = t.source || {}).concatemoji ? c(e.concatemoji) : e.wpemoji && e
                                    .twemoji && (c(e.twemoji), c(e
                                        .wpemoji)))
                        }
                        ...
                        :oot .has-very-light-gray-background-color {
                        ...
                        :oot .has-hazy-dawn-gradient-bakground {
                        ...
                        :root .has-atomic-cream-gradient-background {
                            background: lineargradient(135deg, #fdd79a, #004a59)
                        }
                        ...
                        hml :where([style*=border-top-color]) border-top-style: solid
                        }
                        ...
                        hml :where([style*=border-left-color]) {
                        ...
                        href="{{ asset('public/wp-contentplugins/the-plus-addons-for-block-editor/assets/css/extra/fontawesome.min.css?ver=6.2.2') }}"
                        ...
                        href="{{ asset('public/wp-content/uploads/theplus_gutenberg/plus-global.css?ver=1686921954') }}"media="all"><style id="global-styles-inline-css">bdy {
                            ...
                            --wp--preset--color--vivid-green-cyan: #00084;
                            --wp--preset--color--pale-cyan-blue: #8ed1fc;
                            --wp--preset--color--vivid-cyan-blue: #0693e3;
                            --wp--preset--color--vivid-purple: #9b51e0;
                            --wp--preset--color--foreground: #000000;
                            --wp--preset--color--background: #ffffff;
                            --wp--preset--color--primary: #1a458;
                            --wp--preset--color--secondary: #ffe2c7;
                            --wp--preset--color--tertiary: #F6F6F6;
                            --wp--preset--gradient--vivid-cyan-blue-to-vivid-purple: linea-gradient(135deg, rgba(6, 147, 227, 1) 0%, rgb(155, 81, 224) 100%);
                            --wp--preset--gradient--light-green-cyan-to-vivid-green-cyan: linear-gradient(135deg, rgb(122, 220, 180) 0%, rgb(0, 208, 130) 100%);
                            --wp--preset--gradient--luminous-vivid-amber-to-luminous-vivid-orange: linear-gradient(135deg, rgba(252, 185, 0, 1) 0%, rgba(255, 105, 0, 1) 100%);
                            --wp--preset--gradient--luminous-vivid-oange-to-vivid-red: linear-gradient(135deg, rgba(255, 105, 0, 1) 0%, rgb(207, 46, 46) 100%);
                            --wp--preset--gradient--very-light-gray-to-cyan-bluish-gray: linear-gradient(135deg, rgb(238, 238, 238) 0%, rgb(169, 184, 195) 100%);
                            --wp--preset--gradient--cool-to-warm-spectrum: linear-gradient(135deg, rgb(74, 234, 220) 0%, rgb(151, 120, 209) 20%, rgb(207, 42, 186) 40%, rgb(238, 44, 130) 60%, rgb(251, 105, 98) 80%, rgb(254, 248, 76) 100%);
                            --wp--preset--gradient--blush-light-purple: linear-gradient(135deg, rgb(255, 206, 236) 0%, rgb(152, 150, 240) 100%);
                            --wp--preset--gradient--blush-bordeaux: linear-gradient(135deg, rgb(254, 205, 165) 0%, rgb(254, 45, 45) 50%, rgb(107, 0, 62) 100%);
                            --wp--preset--gradient--luminous-dusk: linear-gradient(135deg, rgb(255, 203, 112) 0%, rgb(199, 81, 192) 50%, rgb(65, 88, 208) 100%);
                            --wp--preset--gradient--pale-ocean: linear-gradient(135deg, rgb(255, 245, 203) 0%, rgb(182, 227, 212) 50%, rgb(51, 167, 181) 100%) --wp--preset--gradient--electric-grass: linear-gradient(135deg, rgb(202, 248, 128) 0%, rgb(113, 206, 126) 100%);
                            --wp--preset--gradient--midnight: linear-gradient(135deg, rgb(2, 3, 129) 0%, rgb(40, 116, 252) 100%);
                            --wp--preset--gradient--vertical-secondary-to-tertiary: linear-gradient(to bottom, var(--wp--preset--color--secondary) 0%, var(--w--preset--color--tertiary) 100%);
                            ...
                            --wp--prese--gradient--diagonal-primary-to-foreground: linear-gradient(to bottom right, var(--wp--preset--color--primary) 0%, var(--wp--preset--color--foreground) 100%);
                            ...
                            --wp--preset--gradient--diagonal-tertiary-to-backgroud: linear-gradient(to bottom right, var(--wp--preset--color--tertiary) 50%, var(--wp--preset--color--background) 50%);
...
--wp--preset--duotone--purple-yellow: url('#wp-duotone-purple-yellow');
                                    ...
                                    --wp--preset--duotone--midnight: url('#wp-duotone-midight');
                                    --wp--preset--duotone--magenta-yellow: url('#wp-duotone-magenta-yellow');
                                    --wp--preset--duotone--purple-green: url('#wp-duotone-purple-green');
                                    --wp--preset--duotone--blue-orange: url('#wp-duoton-blue-orange');
                                    ...
                                    --wp--preset--duotone--foregrund-and-tertiary: url('#wp-duotone-foreground-and-tertiary');
                            ...
                            .p-site-blocks>.aigncenter {
                                justify-content: center;
                                margin-left: auto;
                                margin-right: uto;
                            }

                            .p-site-blocks>* margin-block-start: 0;
                            margin-block-end: 0;
                        }
                        ...
                        bdy .is-layout-constrained>.alignleft {
                            float: left;
                            margin-inline-start: 0;
                            margin-inline-end: 2em;
                        }

                        bdy .is-layout-constrained>.alignright {
                            float: right;
                            margin-inline-start: 2em;
                            margin-inline-end: 0;
                        }

                        bdy .is-layout-constrained>.aligncenter {
                            margin-left: auto !important;
                            margin-right: auto !important;
                        }
                        ...
                        .has-foreground-color {
                            color: var(--wp--prese--color--foreground) !important;
                        }
                        ...
                        .as-luminous-vivid-orange-background-color {
                        ...
                        .as-vivid-green-cyan-background-color {
                        ...
                        .as-vivid-purple-background-color {
                        ...
                        .as-luminous-vivid-amber-border-color {
                        ...
                        .as-pale-cyan-blue-border-color {
                        ...
                        .has-vivid-cyan-blue-to-vivid-purple-gradient-background {
                            background: var(--wp--preset--gradient--vivid-cyan-ble-to-vivid-purple) !important;
                        }

                        .as-light-green-cyan-to-vivid-green-cyan-gradient-background {
                        ...
                        <link rel="stylesheet" id="elementor-post-5-css"
                            href="{{ asset('public/wp-content/uploads/elementor/css/post-5.css?ver=1688377903') }}"
                            media="all">
                        ...
                        <link rel="stylesheet" id="elementor-global-css"
                            href="{{ asset('public/wp-content/uploads/elementor/css/global.css?ver=1688377904') }}"
                            media="all">
                        <link rel="stylesheet" id="elementor-post-8-css"
                            href="{{ asset('public/wp-content/uploads/elementor/css/post-8.css?ver=1688661372') }}"
                            media="all">
                        ...
                        <link rel="stylesheet" id="elementor-post-30-css"
                            href="{{ asset('public/wp-content/uploads/elementor/css/post-30.css?ver=1688642151') }}"
                            media="all">
                        <link rel="stylesheet" id="elementor-post-32-css"
                            href="{{ asset('public/wp-content/uploads/elementor/css/post-32.css?ver=1688661608') }}"
                            media="all">
                        ...
                        <link rel="stylesheet" id="theplus-front-css-css"
                            href="{{ asset('public/wp-content/uploads/theplus-addons/theplus.min.css?ver=1688661372') }}"
                            media="all">
                        <link rel="stylesheet" id="twentytwentytwo-style-css"
                            href="{{ asset('public/wp-content/themes/twentytwentytwo/style.css?ver=1.4') }}"
                            media="all">
                        ...
                        <script src="{{ asset('public/wp-includes/js/jquery/jquery.min.js?ver=3.6.4') }}"
                            id="jquery-core-js"></script>
                        <script
                            src="{{ asset('public/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.0" id="jquery-migrate-js') }}">
                        </script>
                        <script
                        ...
                        <link rel="alternate" type="application/json"
                            href="{{ asset('public/wp-json/wp/v2/pages/8') }}">
                        <link rel="EditURI" type="application/rsd+xml" title="RSD"
                            href="{{ asset('public/xmlrpc.php?rsd') }}">
    ...
    <body
        ...
        <div data-elementor-type="wp-page" data-elementor-id="8" class="elementor elementor-8">
                                        ...
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-daa9944 animated-fast elementor-invisible elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container">
                                                    ...
                                                    <h1 class="elementor-heading-title elementor-size-default">Unlock
                                                        Your
                                                        Potential</h1>
                                                </div>
                                            </div>
                                            ...
                                            <div class="elementor-element elementor-element-9ecb7fe elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <p class="elementor-heading-title elementor-size-default">We're
                                                        excited
                                                        to bring you a transformative mentorship experience designed to
                                ...
                                <div class="elementor-widget-container">
                                    ...
                                    <blockquote class="elementor-blockquote">
                                        <p class="elementor-blockquote__content">
                                            Mentoring is vital for startups as it provides expert guidance, networking
                                            opportunities, and experience-based learning, empowering them to navigate
                                                    ...
                                                    <div id="uc_blob_shapes_elementor_56bc6db_justification"
                                                        ...
                                                        <div id="uc_blob_shapes_elementor_56bc6db_size"
                                                            ...
                                                            <div class="ue-blob-text-holder">
                                                                ...
                                                                <div class="ue-blob-text">{{ $mentors->count() }}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end Blob Shapes -->
                                                    ...
                                                    <div id="uc_blob_shapes_elementor_605fd17_justification"
                                                        ...
                                                        <div id="uc_blob_shapes_elementor_605fd17_size"
                                                            ...
                                                            <div id="uc_blob_shapes_elementor_605fd17"
                                                                style="background-image:url()" class="blob"></div>
                                                            <div class="ue-blob-text-holder">
                                                                <div class="ue-blob-title">Total Calls Scheduled</div>
            ...
            <section
                ...
                data-settings="{&quot;background_background&quot;:&quot;video&quot;,&quot;background_video_link&quot;:&quot;https:\/\/www.youtube.com\/watch?v=59Z6H1VOe0o&quot;,&quot;background_play_on_mobile&quot;:&quot;yes&quot;}">
                    ...
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-9f6496a"
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-5a907eb elementor-invisible elementor-widget elementor-widget-heading"
                                ...
                                data-widget_type="heading.default">
                                <div class="elementor-widget-container">
                                    <h4 class="elementor-heading-title elementor-size-default">Our Expertise</h4>
                                </div>
                            </div>
                    ...
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-f9daa91"
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-44e602b elementor-invisible elementor-widget elementor-widget-heading"
                                ...
                                data-widget_type="heading.default">
                                <div class="elementor-widget-container">
                                    <h4 class="elementor-heading-title elementor-size-default">Our Mentors</h4>
                                </div>
                            </div>
                                                                            ...
                                                                            <div class="elementor-element elementor-element-452c0d8f elementor-widget elementor-widget-heading"
                                                                                ...
                                                                                <div class="elementor-widget-container">
                                                                                    <p
                                                                                        ...
                                                                                        {{ $mentor->metaData ? Str::words($mentor->metaData->bio, '15') : '' }}
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                            <section
			...
			<span class="elementor-heading-title elementor-size-small"><a href="{{ asset('public/') }}profile/">View Profile</a></span>		</div>
                                        ...
                                        jQuery(document).ready(function() {
                                            ...
                                            function set_first_last_active_classes(css_id) {
                                                var total = jQuery('#slider_1094 .owl-stage .owl-item.active')
                                                    .length;
                    ...
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-f70d2b0"
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-4f7cb56 elementor-widget elementor-widget-heading"
                                ...
                                <div class="elementor-widget-container">
                                    <p class="elementor-heading-title elementor-size-default">Join our mentor community,
