			...
			<span class="elementor-heading-title elementor-size-small"><a href="{{ asset('public/') }}profile/">View Profile</a></span>		</div>
                ...
                <!-- <section
                                ...
                                <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-c429127"
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-5fe437d elementor-widget elementor-widget-heading"
                                            data-id="5fe437d" data-element_type="widget"
                                            data-widget_type="heading.default">
                                            <div class="elementor-widget-container">
                                        ...
                                        <div class="elementor-element elementor-element-f82bbec elementor-align-center elementor-widget elementor-widget-button"
                                            data-id="f82bbec" data-element_type="widget"
                                            data-widget_type="button.default">
                                            <div class="elementor-widget-container">
                                                <div class="elementor-button-wrapper">
                                                    <a class="elementor-button elementor-button-link elementor-size-sm"
                        ...
                        <section
                            ...
                            <div class="elementor-container elementor-column-gap-no">
                                <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-760199c"
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-0c4f5bc elementor-blockquote--skin-quotation elementor-blockquote--align-center elementor-blockquote--button-color-official elementor-widget elementor-widget-blockquote"
                                            data-id="0c4f5bc" data-element_type="widget"
                    ...
                    <link rel="stylesheet" id="uc_ac_assets_file_style_css_13102-css"
                        href="{{ asset('public/wp-content/uploads/ac_assets/bubble_float/style.css?ver=1.5.75') }}"
                        media="all">
                    ...
                    <script
                        src="{{ asset('public/wp-includes/js/jquery/ui/core.min.js?ver=1.13.2" id="jquery-ui-core-js') }}">
                    </script>
                    <script
                    ...
                    <script
                        src="{{ asset('public/wp-content/plugins/slide-anything/js/jquery.mousewheel.min.js?ver=3.1.13') }}"
                    ...
                    <script
                        src="{{ asset('public/wp-content/plugins/slide-anything/lightgallery/player.min.js?ver=2.17.1') }}"
