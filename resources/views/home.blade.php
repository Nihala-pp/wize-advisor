...
<htm lang="en-US">
    ...
    <head>
        ...
        r theplus_nonce = "db17101d24"
        </script>
        <meta name="robots" content="max-image-preview:large">
        ink rel="dns-prefetch" href="fonts.googapis.com">
        <link rel="alternate" type="application/rss+xml" title="wiseAdvizor &raquo; Feed"
            href="{{ asset('public/feed/') }}">
        ink rel="alternate" type="application/rss+xml" tle="wiseAdvizor &raquo; Comments Feed"
        href="{{ asset('public/comments/feed/') }}">
        <link rel="icon" type="image/png" href="{{ asset('public/assets/img/PNG-Blue.png') }}">
        ink href="https://cdnjs.cloudflare.com/ax/libs/mdb-ui-kit/6.4.1/mdb.min.css" rel="stylesheet">

        <!-- <link href="{{ asset('public/assets/css/pe-icon-7-stroke.css') }}" rel="stylesheet" />
      ink href="{{ asset('public/sets/css/ct-navbar.css') }}" rel="stylesheet" /> -->
        <script>
        window._wpemojiSettings = {
            "baseUrl": "https:\/\/s.w.org\/images\/core\/emoji\/10.0\/72x72\/",
            "ext": ".png",
        ...
        function c(e) {
            ...
            t.src = t.defer = t.type = "text/javascript", a.getElementsByTagName("head")[0].appendChild(t)
        }
        for (o = Array("flag", "emoji"), t.supports = {
                everything: 0,
                everythingExceptFlag: !0
            }, r = 0; r < o.length; r++) t.supports[o[r]] = function(e) {
            if (p && p.fillText) switch (p.textBaseline = "top", p.ft = "600 32px Arial", e) {
                case "flag":
                ...
                .supports verythingExceptFlag = t.supports.everythingExceptFlag && t.supports[o[r]]);
            t.supports.everythingExceptFlag = t.supports.everythingExceptFlag && !t.supports.flag, t.DOMReady = !1,
                ...
                .readyCallback = function() {
                    ...
                    t.readyCallback()
                }, a.addEventListener ? (a.addEventListener("DOMContentLoaded", n, !1), e.addEventLtener("load",
                    n, !
                    1)) : (e.attachEvent("onload", n), a.attachEvent("onreadystatechange", function() {
                    "complete" === a.readyState && t.readyCallback()
                })), (e = t.source || {}).concatemoji ? c(e.concatemoji) : .wpemoji && e.twemoji && (c(e
                    .twemoji), c(e
                    .wpemoji)))
        ...
        script >
            ...
            !--Google tag(gtag.js) -- >
            <
            script async src = "https://www.googletagmanager.com/gtag/js?id=G-1HZW2R3J0M" >
        </script>
        cript>
        ...
        tyle id="wp-block-library-inline-css">
        :root {
        --wp-admin-theme-color: #007cba;
        --wp-admin-theme-color--rgb: 0, 124, 6;
        ...
        oot .has-very-dark-gray-background-color {
        ...
        oot .has-vivid-green-cyan-to-vivid-cyan-blue-gradie-background {
        ...
        oot .has-subdued-olive-gradient-backgrod {
        ...
        oot .has-midnight-gradient-background
        ...
        border-top-sty: solid
        }

        ml :where([styleborder-right-color]) {
        ...
        border-left-ste: solid
        }

        ml :where([styleborder-width]) {
        border-style: solid
        }
        ...
        border-right-sle: solid
        }

        ml :where([style*=borr-bottom-width]) {
        border-bottom-style: solid
        }
        ...
        --wp-admin--admin-bar--potion-offset: var(--wp-admin--admin-bar--height, 0px)
        }
        ...
        <link rel="stylesheet" id="tpgb-gfonts-global-css"
            href="https://fonts.googleapis.com/css?family=Robo%3A700%2C500%2C400&#038;subset=latin&#038;display=swap&#038;ver=3.0.2"
            media="all">
        <link rel="stylesheet" id="plus-global-css"
            href="https://wiseadvizor.com/wp-content/uploads/tplus_gutenberg/plus-global.css?ver=1686921954"
            media="all">
        ...
        body {
            ...
            --wp--preset--colo-luminous-vivid-amber: #fcb900;
            --wp--preset--color--light-green-cyan: #7bdcb5;
            --wp--preset--color--vivid-green-cyan: #00d084;
            --wp--preset--color--pale-cyan-blue#8ed1fc;
            --wp--preset--color--vivid-cyan-blue: #0693e3;
            --wp--preset--color--vivid-purple: #9b51e0;
            --wp--preset--color--foreground: #0000;
            --wp--preset--color--background: #ffffff;
            --wp--preset--color--primary: #1a4548;
            --wp--preset--color--secoary: #ffe2c7;
            --wp--preset--color--tertiary: #F6F6F6;
            --wp--preset--gradient--vivid-cyan-blue-to-vivid-purple: linear-gradient(135deg, rgba(6, 147, 227, 1) 0%, rgb(155, 81, 224) 100%);
            --wp--preset--gradient--light-green-cyan-to-vivid-green-cyan: lineagradient(135deg, rgb(122, 220, 180) 0%, rgb(0, 208, 130) 100%);
            --wp--preset--gradient--luminous-vivid-amber-to-luminous-vivid-orange: linear-gradient(135deg, rgba(252, 185, 0, 1) 0%, rgba(255, 105, 0, 1) 100%);
            --wp--preset--gradient--luminous-vivid-orange-to-vivid-red: linear-gradient(135deg, rgba(255, 105, 0, 1) 0%, rgb(207, 46, 46) 100%);
            --wp--preset--gradient--vy-light-gray-to-cyan-bluish-gray: linear-gradient(135deg, rgb(238, 238, 238) 0%, rgb(169, 184, 195) 100%);
            --wp--preset--gradient--cool-to-warm-spectrum: linear-gradient(135deg, rgb(74, 234, 220) 0%, rgb(151, 120, 209) 20%, rgb(207, 42, 186) 40%, rgb(238, 44, 130) 60%, rgb(251, 105, 98) 80%, rgb(254, 248, 76) 100%);
            --wp--preset--gradient--blush-light-purple: linear-gradient(135deg, rgb(255, 206, 236) 0%, rgb(152, 150, 240) 100%);
            --wp--preset--gradient--blush-bordeaux: linear-gradient(135deg, rgb54, 205, 165) 0%, rgb(254, 45, 45) 50%, rgb(107, 0, 62) 100%);
            --wp--preset--gradient--luminous-dusk: linear-gradient(135deg, rgb(255, 203, 112) 0%, rgb(199, 81, 192) 50%, rgb(65, 88, 208) 100%);
            --wp--preset--gradient--pale-ocean: linear-gradient(135deg, rgb(255, 245, 203) 0%, rgb(182, 227, 212) 50%, rgb(51, 167, 181) 100%);
            --wp--preset--gradient--ectric-grass: linear-gradient(135deg, rgb(202, 248, 128) 0%, rgb(113, 206, 126) 100%);
            ...
            --wp--preset--gradient--vertical-secondary-to-backgrod: linear-gradient(to bottom, var(--wp--preset--color--secondary) 0%, var(--wp--preset--color--background) 100%);
            ...
            --wp--preset--gradient--diagonal-secondary-to-backound: linear-gradient(to bottom right, var(--wp--preset--color--secondary) 50%, var(--wp--preset--color--background) 50%);
            ...
            --wp--preset--gradient--diagonal-background-to-terary: linear-gradient(to bottom right, var(--wp--preset--color--background) 50%, var(--wp--preset--color--tertiary) 50%);
            --wp--preset--duotone--dark-grayscale: url('#wp-duotone-dark-grayscale');
            --wp--preset--duotone--grayscale: url('#wp-duotone-grayscale');
            --wp--preset--duotone--purple-yellow: url('#wp-duone-purple-yellow');
            --wp--preset--duotone--blue-red: url('#wp-duotone-blue-red');
            --wp--preset--duotone--midnight: url('#wp-duotone-midnight');
            --wp--preset--duotone--magenta-yellow: url('#wp-duone-magenta-yellow');
            --wp--preset--duotone--purple-green: url('#wp-duotone-purple-green');
            --wp--preset--duotone--blue-orange: url('#wp-duotone-blue-orange');
            --wp--preset--duotone--foreground-and-background: l('#wp-duotone-foreground-and-background');
...
--wp--preset--duotone--primary-and-secondary: url('#wp-duotone-primary-and-secondary');
            ...
            --wp--preset--fontize--x-large: clamp(1.75rem, 3vw, 2.25rem);
                ...
                .wp-site-blocks>*+* {
                    ...
                    dy .is-layout-flow>* {
                        ...
                        dy .is-layout-constrained>*+* {
                            ...
                            dy .is-layout-flow>.alignleft {
                                float: left;
                                margin-inline-start: 0;
                                margin-inline-end: 2em;
                            }

                            dy .is-layout-flow>.alignright {
                                float: right;
                                margin-inline-start: 2em;
                                margin-inline-end: 0;
                            }

                            dy .is-layout-flow>.aligncenter {
                                        ...
                                        body .is-layout-constrained>.alignwide {
                                            ...
                                            dy .is-layout-flex {
                                                ...
                                                dy {
                                                    ...
                                                    font-family: var(--wp--pret--font-family--system-font);
                                                ...
                                                where(:not(.wp-element-button)) {
                                                    ...
                                                    h1 {
                                                        font-family: var(--wp--preset--font-family--sourceerif-pro);
                                                        font-size: var(--wp--custom--typography--font-size--colossal);
                                                        font-weight: 300;
                                                        line-height: var(--wp--custom--typography--line-heht--tiny);
                                                    }
                                                    ...
                                                    h3 {
                                                        font-family: var(--wp--preset--font-family--source-serif-pro);
                                                        font-size: var(--wp--custom--typogrhy--font-size--huge);
                                                        font-weight: 300;
                                                        ...
                                                        h4 {
                                                            ...
                                                            .has-black-color {
                                                                ...
                                                                .has-cyan-bluish-gray-color {
                                                                    color: var(--wp--prst--color--cyan-bluish-gray) !important;
                                                                }
                                                                                ...
                                                                                .has-secondary-color {
                                                                                    ...
                                                                                    .has-cyan-bluish-gray-background-color {
                                                                                        ...
                                                                                        .has-vivid-red-background-color {
                                                                                            ...
                                                                                            as-luminous-vivid-amber-background-color {
                                                                                            ...
                                                                                            .has-light-green-cyan-background-color {
                                                                                                ...
                                                                                                as-pale-cyan-blue-background-color {
                                                                                                ...
                                                                                                .has-vivid-cyan-blue-background-color {
                                                                                                    ...
                                                                                                    as-foreground-background-color {
                                                                                                    ...
                                                                                                    .has-background-background-color {
                                                                                                        ...
                                                                                                        .has-tertiary-background-color {
                                                                                                            ...
                                                                                                            as-cyan-bluish-gray-border-color {
                                                                                                                ...
                                                                                                                .has-luminous-vivid-orange-border-color {
                                                                                                                    ...
                                                                                                                    .has-vivid-green-cyan-border-color {
                                                                                                                        ...
                                                                                                                        .has-pale-cyan-blue-border-color {
                                                                                                                            border-color: var(-- w p--preset--color--pale-cyan-blue) !important;
                                                                                                                        }
                                                                                                                        ...
                                                                                                                        .has-foreground-border-color {
                                                                                                                            border-color: var(--wp--preset--c o lor--foreground) !important;
                                                                                                                        }
        ...
        <link rel="stylesheet" id="elementor-post-8-css"
            href="https://wiseadvizor.com/wp-content/uploads/elementor/css/post-8.css?ver=1692629997" media="all">
        ...
        <link rel="stylesheet" id="theplus-front-css-css"
            href="https://wiseadvizor.com/wp-content/uploads/theplus-addons/theplus.min.css?ver=1692629997" media="all">
                                            ...
                                            <div class="elementor-element elementor-element-e10f42e elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <img decoding="async" width="150" height="150"
                                                        ...
                                                        class="attachment-thumbnail size-thumbnail wp-image-601" alt=""
                                                        srcset="{{ asset('public/assets/img') }}/{{ $reviews->user->metaData->profile_pic }}, {{ asset('public/assets/img') }}/{{ $reviews->user->metaData->profile_pic }} 300w, {{ asset('public/assets/img') }}/{{ $reviews->user->metaData->profile_pic }} 600w, {{ asset('public/assets/img') }}/{{ $reviews->user->metaData->profile_pic }} 500w, {{ asset('public/assets/img') }}"
                                                        450w sizes="(max-width: 150px) 100vw, 150px">
                                                    @else
                                                    <img decoding="async" width="150" height="150"
                                                        src="{{ asset('public/wp-content/uploads/2023/06/depositphotos_97431594-stock-photo-businessman-smiling-confidently-at-camera-150x150.webp') }}"
