...
<body
                                            ...
                                            <div class="wpr-switcher-content" data-switcher="1">
                                                <div
                                                    ...
                                                    <h2><strong><img loading="eager" decoding="async"
                                                            ...
                                                            class="mentor_name"
                                                            style="color: #000000">{{ $mentor->name }}</span></h2>
                                                ...
                                                <div
                                                    ...
                                                    <div class="grid-container">
                                                        ...
                                                        <div class="grid-child green">
                                                            <h3><span style="color: #000000">{{ $mentor->name }}</span>
                                                            </h3>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/6.4.1/mdb.min.js"
    ...
    <script async src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js"
