...
<head>
    ...
    <link rel="preload" href="https://wiseadvizor.com/wp-includes/js/jquery/jquery.min.js?ver=3.7.1" id="jquery-core-js" as="script">
    </link>
...
<body
                                        ...
                                        <div class="wpr-switcher-content-wrap">
                                            <div class="wpr-switcher-content" data-switcher="1">
                                                <div
                                                    ...
                                                    <h5><strong><img loading="lazy" decoding="async" class="alignleft wp-image-5531"
    ...
    <script async src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js">
    </script>
    <script async src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js">
    </script>
    <!-- <script type="text/javascript" async src="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/6.4.1/mdb.min.js">
    </script> -->
