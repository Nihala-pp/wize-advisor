...
<head>
    ...
    <meta property="og:url" content="https://wiseadvizor.com/blogs">
    ...
    <meta name="twitter:url" content="https://wiseadvizor.com/blogs">
                                                                                    ...
                                                                                    <div class="elementor-element elementor-element-142649a2 elementor-widget elementor-widget-button"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                class="elementor-button-wrapper">
                                                                                                <a class="elementor-button elementor-button-link elementor-size-sm"
                                                                                                    href="{{ route('blogDetail', [$featured_blog3->id, Str::slug($featured_blog2->title)]) }}">
                                                                                                    <span
                                                                                                        class="elementor-button-content-wrapper">
                                                                                                        <span
                                                                                                            class="elementor-button-text">Read
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="elementor-element elementor-element-49483851 elementor-widget elementor-widget-button"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                class="elementor-button-wrapper">
                                                                                                <a href="{{ route('blogDetail', [$featured_blog1->id, Str::slug($featured_blog1->title)]) }}"
