...
<body>
    ...
    <p>We hope this message finds you well and that you are looking forward to your upcoming mentorship session on {{ $details['date'] }} at {{ $details['time'] }} {{ $details['utc'] }} with {{ $details['mentor_name'] }} on wiseAdvizor.</p><br />
    ...
    <div class="card text-center mt-5">
        <div class="card-body">
            ...
            <p>To access your mentorship session, simply click on the following link at the scheduled time: {{ $details['join_link'] }} or login into your account. Please ensure that you are in a quiet and conducive environment for your session.</p><br />
