...
<body>
    ...
    <p>We are excited to inform you that your requested call with the {{ $details->mentor->name }} has been approved and scheduled! We
    ...
    <div class="card text-center mt-5">
        <div class="card-body">
            ...
            <h5 class="card-title">Joining Link : <a href="{{ $details->call_link }}"> {{ $details->call_link }}</a> </h5><br />
