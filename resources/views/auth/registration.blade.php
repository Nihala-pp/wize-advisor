                                    ...
                                    <form method="POST" action="{{ route('register.post') }}">
                                        ...
                                        <div class="input-group input-group-static mb-0" style="padding-left:5px;">
                                            ...
                                            <input id="name" type="text"
                                                class="form-control @error('name') is-invalid @enderror sm" name="name"
                                        ...
                                        <div class="input-group input-group-static mb-0" style="padding-left:5px;">
                                            ...
                                            <input id="email" type="email"
                                                class="form-control @error('email') is-invalid @enderror sm" name="email"
                                        ...
                                        <div class="input-group input-group-static mb-1" style="padding-left:5px;">
                                            ...
                                            <input id="password" type="password"
                                                class="form-control @error('password') is-invalid @enderror sm"
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select name="timezone"
                                                class="timezone select2 form-control @error('timezone') is-invalid @enderror sm"
                                                required>
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <select class="select form-control @error('expert') is-invalid @enderror sm"
