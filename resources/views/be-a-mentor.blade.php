...
<head>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="https://wiseadvizor.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2F%2Fbe-a-mentor%2F">
    <link rel="alternate" type="text/xml+oembed"
        href="https://wiseadvizor.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2F%2Fbe-a-mentor%2F#038;format=xml">
    <meta name="generator"
                                ...
                                <div class="row" id="row">
                                    <form method="POST" action="{{ route('addMentorRequest') }}">
                                        ...
                                        <div class="input-group input-group-static mb-4">
                                            <label for="exampleFormControlSelect1" class="ms-0">What is your
                                                professional status
                                                ?</label>
                                        ...
                                        <div>
                                            <label class="form-label">Have you any experience in working as a
                                                mentor/advisor to
                                                a start-up ?</label>
                                        ...
                                        <div class="input-group input-group-outline my-3">
                                            <label class="form-label">How much are you looking to charge per session ?
                                                (In
                                                USD)</label>
                                                    ...
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        <div class="elementor-element elementor-element-159e6db elementor-widget elementor-widget-heading"
                                                            ...
                                                            <div class="elementor-widget-container">
                                                                <p
                                                                    class="elementor-heading-title elementor-size-default">
                                                                    <a href="https://wiseadvizor.com/faq/">FAQs</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
