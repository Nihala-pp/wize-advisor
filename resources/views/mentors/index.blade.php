...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            navbar-scroll="true">
            <div class="container-fluid py-1 px-3 card">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">My Dashboard</h6>
                </nav>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        ...
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class="text-danger text-sm font-weight-bolder">-2%</span> than last
                                week</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        ...
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+5% </span>than last
                                week</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('public/assets/img/1685621887.jpg') }}"
                                                            class="avatar avatar-sm me-3" alt="xd">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group mt-2">
                                                    ...
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                                        <img src="{{ asset('public/assets/img/team-4.jpg') }}" alt="team9">
                                                    </a>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group mt-2">
                                                    ...
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Alexander Smith">
                                                        <img src="{{ asset('public/assets/img/team-2.jpg') }}" alt="user3">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('public/assets/img/small-logos/logo-jira.svg') }}" class="avatar avatar-sm me-3" alt="invision">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                            ...
                            <div class="timeline timeline-one-side">
                                <div class="timeline-block mb-3">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">Rescheduled the call for
                                            monday</h6>
                                ...
                                <div class="timeline-block mb-3">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">New call scheduled</h6>
                                ...
                                <div class="timeline-block mb-3">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">2 people show interest in
                                            your profile </h6>
                                ...
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">New Schedule #9583120</h6>
