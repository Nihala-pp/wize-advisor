    ...
    <head>
        <eta charset="UTF-8">
            ...
            <cript>
                ...
                vr theplus_nonce = "db7101d24";
                </script>
                <meta name="robots" content="max-image-preview:large">
                <eta name="csrf-token" content={{ csrf_token() }}" />
                <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700&display=swap" rel="stylesheet">
                <link rel="dns-prefetch" href="//fonts.googleapis.com">
                <ink rel="alternate" type="applicatio/rss+xml" title="wiseAdvizor &raquo; Feed"
        ...
        integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> -->
                    <ink rel="stylesheet"
                        ...
                        <ink rel="stylesheet" href="{{ asset('pubic/assets/css/style.css') }}">
                            ...
                            <cript>
                                ...
                                "source": {
                                "concatemoji":
                                "https:\/\/wiseadvizor.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.2.2"
                                }
                                }
                                ...
                                everythingExceptFlag: !0
                                }, r = 0; r < o.length; r++) t.supports[o[r]]=function(e) { if (p && p.fillText) switch
                                    (p.textBaseline="top" , p.font="600 32px Arial" , e) { case "flag" : return
                                    s("🏳️‍⚧️", "🏳️​⚧️" ) ? !1 : !s("🇺🇳", "🇺​🇳" ) &&
                                    !s("🏴󠁧󠁢󠁥󠁮󠁧󠁿", "🏴​󠁧​󠁢​󠁥​󠁮​󠁧​󠁿" ); case "emoji" : return
                                    !s("🫱🏻‍🫲🏿", "🫱🏻​🫲🏿" ) } return !1 }(o[r]),
                                    t.supports.everything=t.supports.everything && t.supports[o[r]], "flag" !==o[r] &&
                                    (t.supports .everythingExceptFlag=t.supports.everythingExceptFlag &&
                                    t.supports[o[r]]); t.supports.everythingExceptFlag=t.supports.everythingExceptFlag
                                    ...
                                    { "complete"===a.readyState && t.readyCallback() })), (e=t.source || {}).concatemoji
                                    ? c(e.concatemoji) : e.wpemoji && e.twemoji && (c(e.twemoji), c(e .wpemoji)))
                                    ...
                                    <tyle>
                                        ...
                                        @edia (-webkit-min-device-pixel-ratio:2),
                                        ...
                                        :oot .has-purple-crush-grdient-background {
                                        ...
                                        :oot .has-atomic-cream-gradientbackground {
                                        ...
                                        hml :where([syle*=border-bottom-color]) {
                                        ...
                                        hml :where([style*=border-top-width]) {
                                            border-top-style: solid
                                        }
                                        ...
                                        hml :where([style*=border-left-width]) {
                                            border-left-style: solid
                                        }
                                        ...
                                        <ink rel="preload"
                                            ...
                                            as="style" id="tpgb-fontawesome" media="all"
                                            ...
                                            <oscript>
                                                ...
                                                <link rel="stylesheet" id="tpgb-gfonts-global-css" href="
    h
ttps://fonts.googleapis.com/css?family=Roboto%3A700%2C500%2C400&#038;subset=latin&#038;display=swap&#038;ver=3.0.2"
                                                    media="all">
                                                <link rel="stylesheet" id="plus-global-css" href="{{ asset('public/wp-co
    t
e     <style id="global-styles-inline-css">
    b          --wp--preset--color--black: 
    0
00000;
    ...
    <link rel="stylesheet" id="niso-carousel-fontello-css"
        href="{{ asset('public/wp-content/plugins/niso-carousel-slider/assets/css/fontello.css?ver=1.0') }}"
                                                ...
                                                <script
                                                    src="{{ asset('public/wp-includes/js/jquery/jquery.min.js?ver=3.6.4') }}"
                                                    id="jquery-core-js"></script>
                                                <script
                                                    src="{{ asset('public/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.0') }}"
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="scheduleCallForm">
                                ...
                                <input type="hidden" class="mentor" name="mentor"
                                                                ...
                                                                <div class="content w-100">
                                                                    <div class="calendar-container">
                                                                        <div class="calendar">
                                                                            ...
                                                                            <button class="button" id="add-button">Add
                                                                                Event</button>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <form class="form" id="form">
                                                                            <div class="form-container" align="center">
                                                                                ...
                                                                                <input class="input" type="text"
                                                                                    id="name" maxlength="36">
                                                                                <label class="form-label"
                                                                                    id="valueFromMyButton"
                                                                                    for="count">Number of people to
                                                                                    invite</label>
                                                                                <input class="input" type="number"
                                                                                    id="count" min="0" max="1000000"
                                                                                    maxlength="7">
                                                                                <input type="button" value="Cancel"
                                                                                    class="button" id="cancel-button">
